...
| `problem-solving-principles.md` | Legacy reference 유지 | Active는 `docs/operations/*` + 각 스킬 `references/philosophy.md`를 사용 |
...
3. 운영 문서(`skills-operations.md`) 기준으로 대체 가능성 검증 완료
