...
- `sync-agent-skills`: 다른 에이전트 스킬을 Claude 형식으로 동기화

## 형식 규칙

- `SKILL.md` frontmatter는 Claude 형식을 사용합니다.
- 필수 메타 필드:
  - `name`
  - `description`
  - `allowed-tools`
...
- 공통 스킬 업데이트 시 `.codex/skills`, `.gemini/skills`와 함께 동기화합니다.
