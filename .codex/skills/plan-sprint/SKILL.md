...
- `.agile/loops/loop-vN/sprint/03-us-N.M-retrospective.md`
- `.agile/loops/loop-vN/sprint/04-sprint-retrospective.md` (스프린트 회고 본문)
...
## 권장 실행 순서
1. Plan: `.agile/loops/loop-vN/02-design-phase.md` 기반으로 `01-sprint-plan.md` 생성/확정 (US별 Step 작성 포함)
...
6. Status: 진행률과 일정 리스크를 `02-sprint-status.md`에 기록
7. US Retrospective: 각 US 완료 후 `03-us-N.M-retrospective.md` 작성
8. Sprint Retrospective: `04-sprint-retrospective.md` 작성
9. 다음 라운드 결정

## 루프 리뷰 규칙
`.agile/loops/loop-vN/sprint/04-sprint-retrospective.md`는 스프린트 회고 문서이며, 아래 5개를 반드시 작성:
1. 검증된 가정 (True)
2. 반박된 가정 (False)
3. 새로 생긴 Unknown
4. 유지할 전략
...
## 다음 라운드 결정 규칙
- 2W 자체가 바뀜: `/define-2w`로 재진입 (`01-02-define-2w.md (다음 loop-vN+1 디렉터리)`)
- 2W는 유지, 설계(Phase)만 수정: `/design-phase`로 재진입 (`02-design-phase.md (다음 loop-vN+1 디렉터리)`)
- 목표 달성: 루프 종료
...
## 완료 조건 (Done)
- `01-sprint-plan.md`, `02-sprint-status.md` 작성 완료
- 완료된 US마다 `03-us-N.M-retrospective.md` 작성 완료
- `.agile/loops/loop-vN/sprint/04-sprint-retrospective.md`(스프린트 회고) 작성 완료
- 다음 라운드 진입 경로 확정
