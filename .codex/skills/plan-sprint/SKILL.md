---
name: plan-sprint
description: "Sprint 계획/진행/완료를 한 흐름으로 운영하는 메인 스킬. 실행-검증-학습 루프로 Sprint 결과를 2W/Phase-US 다음 버전에 반영한다."
---

# Plan Sprint

## 목적
Sprint를 계획하고 실행/점검/완료까지 운영한 뒤, 결과를 다음 `2W vN+1 / Phase-US vN+1`에 반영하는 **학습 루프**를 강제한다.
...
- `references/philosophy.md`
  - 왜 매 스프린트 종료 후 2W/Phase-US 재진입이 필요한지 확인할 때
...
## 다음 라운드 결정 규칙
- 2W 자체가 바뀜: `/define-2w`로 재진입 (`2w-vN+1.md`)
- 2W는 유지, 설계(Phase/US)만 수정: `/design-phase-us`로 재진입 (`1h-vN+1.md`)
- 목표 달성: 루프 종료
...
## 다음 단계
- 결정에 따라 `/define-2w` 또는 `/design-phase-us`
