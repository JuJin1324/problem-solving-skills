...
- `references/philosophy.md`
  - 왜 1H를 Phase 중심으로 설계하는지 확인할 때
  - Step 책임 분리(1H vs Sprint)가 헷갈릴 때
...
- 선행 의존사항
- Step 작성 책임: `/agile-loop-sprint` Plan 단계

## 안티패턴
- Phase 없이 US만 나열해 전체 흐름이 사라짐
- Out/Unknown을 비워 Scope가 커짐
- 1H에서 Step까지 확정해 Sprint 설계와 중복됨
