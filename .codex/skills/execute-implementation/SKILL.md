...
## 목적
`design-implementation-vN.md`를 바탕으로 코드를 구현하고 검증한다.
...
## 입력
- `problems/[문제명]/design-implementation-vN.md`
- `.agile/sprints/sprint-N/plan.md`

## 출력물
- 코드 변경사항
- `problems/[문제명]/execute-implementation-us-N.M-vN.md`
...
### 6단계. 실행 결과 문서화
- `execute-implementation-us-N.M-vN.md`에 결과, 증적, 남은 리스크 기록
...
- 테스트/검증 결과 기록 완료
- 컨벤션 체크리스트 확인 완료
- `execute-implementation-us-N.M-vN.md` 작성 완료
