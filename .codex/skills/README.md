...
- `agile-loop-1h-planning`: 2W vN 기반으로 1페이즈 분량의 Phase+US/지표/완료조건을 설계 (Step은 sprint에서 작성)
- `agile-loop-sprint`: Sprint 계획/진행/완료/US 완료를 통합 운영하고 다음 2W/1H Planning 라운드로 반영
