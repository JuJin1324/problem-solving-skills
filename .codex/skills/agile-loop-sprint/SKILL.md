...
description: "Sprint 계획/진행/완료를 한 흐름으로 운영하는 메인 스킬. 실행-검증-학습 루프로 Sprint 결과를 2W/Backlog/1H 다음 버전에 반영한다."
---

# Agile Loop Sprint

## 목적
Sprint를 계획하고 실행/점검/완료까지 운영한 뒤, 결과를 다음 `2W vN+1 / Backlog vN+1 / 1H vN+1`에 반영하는 **학습 루프**를 강제한다.
...
- `references/philosophy.md`
  - 왜 매 스프린트 종료 후 2W/Backlog/1H 재진입이 필요한지 확인할 때
...
- 2W는 유지, 우선순위/컷라인이 바뀜: `/agile-loop-backlog`로 재진입 (`backlog-vN+1.md`)
- 2W/Backlog는 유지, How만 수정: `/agile-loop-1h`로 재진입 (`1h-vN+1.md`)
- 목표 달성: 루프 종료
...
## 다음 단계
- 결정에 따라 `/agile-loop-2w` 또는 `/agile-loop-backlog` 또는 `/agile-loop-1h`
