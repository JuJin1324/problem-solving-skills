...
## 목적
`implementation-design-vN.md`를 바탕으로 코드를 구현하고 검증한다.
...
## 출력물
- 코드 변경사항
- `problems/[문제명]/implementation-exec-us-N.M-vN.md`

템플릿:
- `templates/implementation-exec-vN.md`
...
### 6단계. 실행 결과 문서화
- `implementation-exec-us-N.M-vN.md`에 결과, 증적, 남은 리스크 기록
...
- 테스트/검증 결과 기록 완료
- 컨벤션 체크리스트 확인 완료
- `implementation-exec-us-N.M-vN.md` 작성 완료
- 코드-요구사항 매핑 및 구현 의도 설명 완료

## 다음 단계
- 필요 시 `/agile-loop-sprint` 상태 업데이트
