...
**사용자 선택:**
- **1번 선택:** plan-draft.md를 sprint-plan.md로 rename, Sprint 시작
...
**확정 후:**
- `plan-draft.md` → `sprint-plan.md` 로 rename
...
📂 파일 위치: .agile/sprints/sprint-N/sprint-plan.md

💡 진행 방법:
1. sprint-plan.md 파일을 직접 수정하며 진행 상황 업데이트
2. 완료한 태스크: [ ] → [x]
...
- ✅ sprint-plan.md 파일을 직접 수정 (AI가 대신하지 않음)
...
- 사용자 동의 없이 Sprint 시작
- sprint-plan.md 파일을 사용자 동의 없이 수정
...
1. **sprint-plan.md 파일 직접 수정** - 진행하면서 체크리스트 업데이트
